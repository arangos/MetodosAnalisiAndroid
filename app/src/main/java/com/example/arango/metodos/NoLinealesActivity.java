...
public class NoLinealesActivity extends Activity {
    ...
    private EditText edtxtFuncion, edtxtValorInicial, edtxtDelta, edtxtIteraciones, edtxtAd1 ,edtxtAd2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtxtAd2 = (EditText) findViewById(R.id.edtxtAd2);
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (i){
                    ...
                    case 6:
                        ...
                        break;
                    default:
                        edtxtAd1.setHint("Tolerancia");
                        edtxtAd2.setHint("Iteraciones");
                        edtxtAd1.setVisibility(View.VISIBLE);
                        edtxtAd2.setVisibility(View.VISIBLE);
                        break;
                }
            ...
            public void onClick(View view) {
                if(metodo_a_usar < 0){
                    ...
                    try {
                        ...
                        double delta = Double.parseDouble(edtxtDelta.getText().toString().trim());
                        double[][] tabla;
                        String result;
                        switch (metodo_a_usar) {
                            case 0:
                                ecunl.busquedas(x0, delta, iter);
                                tabla = ecunl.getTabla();
                                result = getResult(tabla);
                                txtResult.setText(result);
                                break;
                            case 1:
                                ecunl.biseccion(x0, Double.parseDouble(edtxtAd1.getText().toString()), Double.parseDouble(edtxtAd2.getText().toString()), iter);
                                tabla = ecunl.getTabla();
                                result = getResult(tabla);
                                txtResult.setText(result);
                                break;
                            case 2:
                                ecunl.reglaFalsa(x0, Double.parseDouble(edtxtAd1.getText().toString()), Double.parseDouble(edtxtAd2.getText().toString()), iter);
                                tabla = ecunl.getTabla();
                                result = getResult(tabla);
                                txtResult.setText(result);
                                break;
